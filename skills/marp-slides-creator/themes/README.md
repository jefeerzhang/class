...
制作 slides 时，根据选择的主题直接查下表确定标题格式：

| 主题 | 内容页标题 | 标题页指令 | 分隔页 | 备注 |
|------|-----------|-----------|--------|------|
| **beam** | `#` (h1) | `<!-- _class: title -->` | `# Part X` | h1 显示在顶部蓝色条中 |
| **academic** | `#` (h1) | `class: lead` | `# Part X` | maroon 红色标题栏 |
| **jobs** | `#` (h1) | `class: titlepage` | `# Part X` | 有蓝色下划线样式 |
| **gaia** | `##` (h2) | `class: lead` | `# Part X` | h2 带蓝色下划线 |
| **graph_paper** | `##` (h2) | 无特殊要求 | `# Part X` | 方格纸背景 |
| **simple** | `##` (h2) | 无特殊要求 | `# Part X` | 极简设计 |
| **companyLightBlue** | `##` (h2) | 无特殊要求 | `# Part X` | 企业浅蓝 |
| **companySZ** | `##` (h2) | 无特殊要求 | `# Part X` | 企业深色 |
| **zju** | `##` (h2) | 无特殊要求 | `# Part X` | 浙大官方风格 |
| **turing** | `##` (h2) | 无特殊要求 | `# Part X` | 技术风格 |
| **gradient** | `##` (h2) | 无特殊要求 | `# Part X` | 渐变背景 |
| **socrates** | `##` (h2) | 无特殊要求 | `# Part X` | 哲学/人文 |
| **einstein** | `##` (h2) | 无特殊要求 | `# Part X` | 科学风格 |
| **border** | `##` (h2) | 无特殊要求 | `# Part X` | 简约边框 |
| **academic-lightblue** | `##` (h2) | 无特殊要求 | `# Part X` | 学术浅蓝 |

> **记忆口诀**：beam/academic/jobs 三个用 `#`，其余全部用 `##`。
...
| 产品发布 | jobs | gradient |
| 企业汇报 | companyLightBlue, companySZ | gaia |
| 教学演示 | simple, graph_paper | academic |
| 创意展示 | gradient | jobs |
| 商务演示 | gaia | simple, companyLightBlue |
| 数据报告 | gaia, companyLightBlue | simple |
